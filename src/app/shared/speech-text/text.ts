export const SPEECH = {
  correctGuess: 'Jeg vet hva det er, det er ',
  couldntGuess: 'Jeg greide dessverre ikke gjette hva du tegnet.',
  welcome: 'Hei, jeg heter Kunstige Jens. Kan du hjelpe meg å lære?',
  gameMode: 'Velg modus: 1 spiller. 2 spiller.',
